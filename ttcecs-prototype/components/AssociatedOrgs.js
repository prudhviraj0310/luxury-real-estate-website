...
const organizations = [
  {
    ...
    backDescription: 'Comprehensive healthcare facility offering modern treatment, diagnostics, and wellness programs for TTCECS members and families.',
  ...
  return (
    <section id="ecosystem" className={`py-24 ${bgGradient} relative overflow-hidden`}>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <p className="text-sm">
            <span className="text-electric font-semibold">✨ TTCECS Members Benefit:</span>
