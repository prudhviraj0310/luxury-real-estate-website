...
export default function Chatbot() {
  ...
  useEffect(() => {
    ...
    if (raw) {
      ...
      setMessages([{
        id: Date.now(),
        text: '👋 Hi, I\'m TTCECS Assistant — how can I help you today?',
        sender: 'bot',
        timestamp: Date.now()
      }]);
    }
          ...
          >
            ...
            <div className={`px-4 py-3 ${isDark ? 'bg-[#071428]' : 'bg-gradient-to-r from-brand-blue to-brand-purple'} border-b ${borderColor} flex items-center justify-between`}>
              <div className="flex items-center gap-3">
                <Avatar type="bot" name="TTCECS" size={36} />
                <div>
                  <h3 className={`font-bold text-sm text-white`}>TTCECS Assistant</h3>
                ...
                return (
                  ...
                  >
                    <div className="flex-shrink-0">
                      <Avatar type={isBot ? 'bot' : 'user'} name={isBot ? 'TTCECS' : 'You'} size={32} />
                    </div>
